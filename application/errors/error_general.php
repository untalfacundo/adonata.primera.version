        ...
        <div class="container">
            <section id="404">
                <div class="error-page">
                    <div class="title">
                        <img alt="" src="<?php echo base_url();?>assets/img/error-page-background.png" class="top">
                        <header>Error</header>
                        <img alt="" src="<?php echo base_url();?>assets/img/error-page-background.png" class="bottom">
                    </div>
                    <h2 class="no-border">Parece que esta p&aacute;gina no existe</h2>
                    <a href="<?php echo base_url(); ?>" class="link-arrow back">Volver</a>
                </div>
            </section>
        </div><!-- /.container -->
    </div>
        ...
        <footer id="page-footer">
            <div class="inner">
                ...
                <section id="footer-copyright">
                    <div class="container">
                        <span><img src="<?php echo base_url(); ?>assets/img/logoa.png" style="width: 80px; height: 40px;"></span>
                        <span class="pull-right"><a href="#page-top" class="roll"><img src="<?php echo base_url(); ?>assets/img/flecha.png" style="margin-top: 5px;"></a></span>
